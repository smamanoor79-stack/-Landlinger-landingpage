          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <motion.button
                type="submit"
                disabled={loading}
                className="w-full bg-[#C6EA6D] text-[#12271D] font-semibold py-3 rounded-full transition-colors duration-300 hover:bg-lime-300 disabled:opacity-60 disabled:cursor-not-allowed"
                initial={{ opacity: 0, y: 15 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true, amount: 0.5 }}
