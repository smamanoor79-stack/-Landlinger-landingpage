                ...
                <div className="flex flex-col gap-6">
                    ...
                    >
                        ...
                        <button
                            ...
                            className="w-full bg-white hover:bg-gray-100 text-gray-900 font-semibold py-3 rounded-full transition disabled:opacity-60 disabled:cursor-not-allowed"
                        >
                    ...
                    >
                        ...
                        <button
                            ...
                            disabled={loadingPlan === "custom"}
                            className="w-full bg-lime-300 hover:bg-lime-400 text-gray-900 font-semibold py-3 rounded-full transition disabled:opacity-60 disabled:cursor-not-allowed"
                        >
                            {loadingPlan === "custom" ? "Redirecting..." : "Get Started"}
                        </button>
                    </motion.div>
